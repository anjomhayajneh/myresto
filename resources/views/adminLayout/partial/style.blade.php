...
<link rel="stylesheet" href="{{ asset('dashboard/css/jquery.timpicker.css') }}">
...
<link rel="stylesheet" href="{{ asset('dashboard/css/css/app-dark.css.css') }}" id="darkTheme" disabled>
